...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { end: @semester.end, semester: @semester.semester, session_id: @semester.session_id, start: @semester.start, status: @semester.status }
    end
  ...
  test "should update semester" do
    patch :update, id: @semester, semester: { end: @semester.end, semester: @semester.semester, session_id: @semester.session_id, start: @semester.start, status: @semester.status }
    assert_redirected_to semester_path(assigns(:semester))
  end
